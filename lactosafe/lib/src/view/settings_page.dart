...
import 'package:LactoSafe/src/controller/settings_page_controller.dart';
    ...
    return Consumer<AuthService>(builder: (context, auth, _) {
      ...
      return Scaffold(
        appBar: AppBar(
          ...
          actions: [PhotoWidget(picture: AppImages.logoLetterless)],
        ),
        body: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                  padding: EdgeInsets.only(
                      right: AppSettings.screenWidth / 8,
                      left: AppSettings.screenWidth / 8),
                  child: const Divider(
                    height: 3.0,
                    thickness: 1.5,
                  )),
              SizedBox(
                height: AppSettings.screenHeight / 25,
              ),
              TextButton(
                  onPressed: () {},
                  child: Text(
